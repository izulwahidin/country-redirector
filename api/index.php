...
$costumTiers = [
    ...
    'tier1' => [
        ...
        "country": [
            'US', 'CA', 'GB', 'DE', 'FR', 'AU', 'NZ', 'JP', 
            'SE', 'NO', 'DK', 'FI', 'CH', 'NL', 'BE', 'IE'
        ]
    ],
    ...
    'tier2' => [
        ...
        "country": [
            'IT', 'ES', 'AT', 'PT', 'IL', 'AE', 'SA', 'KW',
            'QA', 'BH', 'SG', 'HK', 'KR', 'TW', 'IS', 'LU'
        ]
    ],
    ...
    'tier3' => [
        ...
        "country": [
            'PL', 'CZ', 'HU', 'GR', 'RO', 'BG', 'HR', 'RS',
            'SK', 'SI', 'EE', 'LV', 'LT', 'CY', 'MT', 'MY',
            'TH', 'BR', 'MX', 'AR', 'CL', 'CO', 'PE', 'TR'
        ]
    ],
    ...
    "junk" =>  [
        "direct_link":  "https://www.profitablecpmrate.com/cfdfjuyx?key=b49cba82c72a34289daa2af321075210",
        "country": ['XX', 'T1']
    ],
];
